  ...
  <nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
      <ul class="nav metismenu" id="side-menu">
        <li class="nav-header">
          <div class="dropdown profile-element"> <span>
            ...
            <ul class="dropdown-menu animated fadeInRight m-t-xs">
              <li><a href="<%=path%>/ui/profile.html">Profile</a></li>
              <li><a href="<%=path%>/ui/contacts.html">Contacts</a></li>
              <li><a href="<%=path%>/ui/mailbox.html">Mailbox</a></li>
              <li class="divider"></li>
              <li><a href="<%=path%>/ui/login.html">Logout</a></li>
            </ul>
          </div>
        ...
        <li class="active">
          <a href="<%=path%>/ui/index.html"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboards</span> <span class="fa arrow"></span></a>
          <ul class="nav nav-second-level">
            <li class="active"><a href="<%=path%>/ui/index.html">Dashboard v.1</a></li>
            <li><a href="<%=path%>/ui/dashboard_2.html">Dashboard v.2</a></li>
            <li><a href="<%=path%>/ui/dashboard_3.html">Dashboard v.3</a></li>
            <li><a href="<%=path%>/ui/dashboard_4_1.html">Dashboard v.4</a></li>
            <li><a href="<%=path%>/ui/dashboard_5.html">Dashboard v.5 </a></li>
          </ul>
        </li>
        <li>
...
<!-- GITTER -->
<script src="<%=path%>/ui/js/plugins/gritter/jquery.gritter.min.js"></script>
...
<!-- Toastr -->
<script src="<%=path%>/ui/js/plugins/toastr/toastr.min.js"></script>
